 ...
 * @version     4.1.0 (Feature: Add Medical Expense Tax Credit checkbox)
 * @file        uiCore.js
 * @created     2025-10-25
    ...
    document.querySelectorAll('[data-lang-key]').forEach(el => {
        ...
        if (translation !== undefined && translation !== null) {
            if (typeof translation === 'function') { 
                if (key !== 'simComplete' && key !== 'futureValueDisplay' && key !== 'incomeItemLabel') {
