 ...
 * @version     5.3.0 (Feature: Add OAS residency years input)
 * @file        uiCore.js
 * @created     2025-10-25
...
const translations = {
    en: {
        ...
        // *** MODIFICATION START v5.2.0: Add JSON Save/Load Keys ***
        loadScenarioBtn: "Load Scenario",
        ...
        // *** MODIFICATION START v5.3.0: Add OAS Years Keys ***
        userYearsInCanadaLabel: "Years in Canada (18+)", userYearsInCanadaTooltip: "Years lived in Canada after age 18. Used to calculate OAS eligibility (40 years for full, 10 for partial).",
        // *** MODIFICATION END v5.3.0 ***
        legendOtherIncome: "Other Income (Non-CPP)", otherIncomeDesc: "Manage other income sources.",
        manageIncomeExpensesBtn: "[ Manage Income & Expenses ]", // *** MODIFIED v4.0.0 ***
        ...
        runMonteCarloBtn: "Run Monte Carlo", monteCarloRunsLabel: "Simulation Runs:",
        ...
        phase1Title: "Phase 1", phase2Title: "Phase 2", phase3Title: "Phase 3", phaseStartAge: "Start Age", phaseEndAge: "End Age", // phaseExpenses key removed
        ...
        // Optimizer keys removed
        // *** MODIFICATION START v3.3.0 ***
        runOptimizationBtn: "Run Optimization Comparison",
        loadingTextOptimizer: "Running Optimization...",
        // *** MODIFICATION END v3.3.0 ***
        modalTitle: "Manage Income & Expenses", // *** MODIFIED v4.0.0 ***
        modalAddTitle: "Add/Edit", 
        incomeTypeLabel: "Type", // *** ADDED v4.0.0 ***
        incomeTypeIncome: "Income", // *** ADDED v4.0.0 ***
        incomeTypeExpense: "Expense", // *** ADDED v4.0.0 ***
        ...
        incomeColaLabel: "COLA (%)", incomeColaTooltip: "Individual Cost of Living Adjustment for this item. Use 0 for none.",
        incomeIsMedicalLabel: "Report as Medical Expense", // *** 신규 추가 (v4.1.0) ***
    ...
    ko: {
        ...
        // *** MODIFICATION START v5.2.0: Add JSON Save/Load Keys ***
        loadScenarioBtn: "불러오기",
        saveScenarioBtn: "저장하기",
        // *** MODIFICATION END v5.2.0 ***
        ...
        // *** MODIFICATION START v5.3.0: Add OAS Years Keys ***
        userYearsInCanadaLabel: "캐나다 거주 기간 (18세 이후)", userYearsInCanadaTooltip: "18세 이후 캐나다에 거주한 기간(년)입니다. OAS 수령 자격 계산에 사용됩니다 (40년 만기, 10년 최소).",
        // *** MODIFICATION END v5.3.0 ***
        legendOtherIncome: "기타 소득 (CPP 외)", otherIncomeDesc: "다른 소득 관리",
        manageIncomeExpensesBtn: "[ 수입 및 지출 관리 ]", // *** MODIFIED v4.0.0 ***
        ...
        runMonteCarloBtn: "몬테카를로 실행", monteCarloRunsLabel: "시뮬레이션 횟수:",
        mcTitle: "몬테카를로 시뮬레이션 결과", mcSubTitle: (runs) => `${runs.toLocaleString()}회 무작위 실행 기반`,
        mcSuccessRate: "성공률", mcSuccessDesc: "(자산이 고갈되지 않은 비율)",
        mcP10: "하위 10%", mcP10Desc: "(10th percentile 결과)",
        mcMedian: "중간값", mcMedianDesc: "(50th percentile 결과)",
        mcP90: "상위 10%", mcP90Desc: "(90th percentile 결과)",
        mcFinalAssets: "최종 총 자산",
        // *** OPTIMIZED MONTE CARLO (v5.1.0) ***
        runOptimizedMonteCarloBtn: "최적화 몬테카를로 실행", optimizedMonteCarloRunsLabel: "최적화 횟수:",
        // *** END MONTE CARLO ***
        ...
        phase1Title: "단계 1", phase2Title: "단계 2", phase3Title: "단계 3", phaseStartAge: "시작 나이", phaseEndAge: "종료 나이", // phaseExpenses key removed
        ...
        // Optimizer keys removed
        // *** MODIFICATION START v3.3.0 ***
        runOptimizationBtn: "최적화 비교 실행",
        loadingTextOptimizer: "최적화 계산 중...",
        // *** MODIFICATION END v3.3.0 ***
        modalTitle: "수입 및 지출 관리", // *** MODIFIED v4.0.0 ***
        modalAddTitle: "추가/수정",
        incomeTypeLabel: "유형", // *** ADDED v4.0.0 ***
        incomeTypeIncome: "수입", // *** ADDED v4.0.0 ***
        incomeTypeExpense: "지출", // *** ADDED v4.0.0 ***
        incomeDescLabel: "항목", incomeAmountLabel: "금액(현재가)", incomeStartAgeLabel: "시작 나이", incomeEndAgeLabel: "종료 나이", saveIncomeBtn: "저장",
        incomeColaLabel: "물가상승률 (%)", incomeColaTooltip: "이 항목에 적용될 개별 물가상승률입니다. 없으면 0을 사용하세요.",
        incomeIsMedicalLabel: "의료비로 신고", // *** 신규 추가 (v4.1.0) ***
        ...
        metricsScenarioA: "시나리오 A", metricsScenarioB: "시나리오 B", metricsDifference: "Difference (B - A)",
        tableTitle: "Detailed Year-by-Year Comparison", colAge: "Age", colTotalAssets: "Total Assets",
        colIncomeCPP: "Inc: CPP", colIncomeOAS: "Inc: OAS", colIncomeGIS: "Inc: GIS", colIncomeOther: "Inc: Other", colIncomeTotal: "Inc: Total",
        colExpenses: "Expenses", colTaxesPaid: "Taxes Paid", colNetCashflow: "Net Cashflow",
        colWdRRSP: "WD: RRSP", colWdLIF: "WD: LIF", colWdNonReg: "WD: NonReg", colWdTFSA: "WD: TFSA", colWdTotal: "WD: Total",
...
function initializeCore() {
    ...
    const allElementIds = [
        ...
        // *** MODIFICATION START v5.2.0: Add JSON Save/Load IDs ***
        'load-scenario-btn', 'save-scenario-btn', 'scenario-file-input',
        // *** MODIFICATION END v5.2.0 ***
        // A
        'dataEntryTarget_a', 'province', 'lifeExpectancy', 'retirementAge_a', 'userBirthYear', 'cppStartAge_a', 'userCppAt65', 'oasStartAge_a', 'hasSpouse', 
        // *** MODIFICATION START v5.3.0: Add OAS Years ID ***
        'userYearsInCanada',
        // *** MODIFICATION END v5.3.0 ***
        'manage-income-btn', 'income-modal', 'save-income-btn', 'income-list', 'income-id', 'income-owner', 'future-value-display', 'add-income-form', 'income-cola', 
        'income-type', // *** 'income-type' ADDED v4.0.0 ***
        'income-is-medical', // *** 신규 추가 (v4.1.0) ***
        'asset_rrsp', 'asset_tfsa', 'asset_nonreg', 'asset_lif', 'asset_nonreg_acb',
        'return_rrsp', 'return_tfsa', 'return_nonreg', 'return_lif', 'cola',
        'stdev_rrsp', 'stdev_tfsa', 'stdev_nonreg', 'stdev_lif', // *** MONTE CARLO (v5.0.0) ***
        'phase1_startAge_a', 'phase1_endAge_a', 'phase1_order1_a', 'phase1_order2_a', 'phase1_order3_a', 'phase1_order4_a', // phase1_expenses_a REMOVED
        'phase2_startAge_a', 'phase2_endAge_a', 'phase2_order1_a', 'phase2_order2_a', 'phase2_order3_a', 'phase2_order4_a', // phase2_expenses_a REMOVED
        'phase3_startAge_a', 'phase3_endAge_a', 'phase3_order1_a', 'phase3_order2_a', 'phase3_order3_a', 'phase3_order4_a', // phase3_expenses_a REMOVED
        // B
        'dataEntryTarget_b', 'province_b', 'lifeExpectancy_b', 'retirementAge_b', 'userBirthYear_b', 'cppStartAge_b', 'userCppAt65_b', 'oasStartAge_b', 'hasSpouse_b', 
        // *** MODIFICATION START v5.3.0: Add OAS Years ID ***
        'userYearsInCanada_b',
        // *** MODIFICATION END v5.3.0 ***
        'manage-income-btn_b', 'income-modal_b', 'save-income-btn_b', 'income-list_b', 'income-id_b', 'income-owner_b', 'future-value-display_b', 'add-income-form_b', 'income-cola_b', 
        'income-type_b', // *** 'income-type_b' ADDED v4.0.0 ***
        'income-is-medical_b', // *** 신규 추가 (v4.1.0) ***
        ...
        'stdev_rrsp_b', 'stdev_tfsa_b', 'stdev_nonreg_b', 'stdev_lif_b', // *** MONTE CARLO (v5.0.0) ***
        'phase1_startAge_b', 'phase1_endAge_b', 'phase1_order1_b', 'phase1_order2_b', 'phase1_order3_b', 'phase1_order4_b', // phase1_expenses_b REMOVED
        'phase2_startAge_b', 'phase2_endAge_b', 'phase2_order1_b', 'phase2_order2_b', 'phase2_order3_b', 'phase2_order4_b', // phase2_expenses_b REMOVED
        'phase3_startAge_b', 'phase3_endAge_b', 'phase3_order1_b', 'phase3_order2_b', 'phase3_order3_b', 'phase3_order4_b', // phase3_expenses_b REMOVED
        // Common/Result
        ...
        // 'optimizer-link-container' removed
        // *** MODIFICATION START v3.3.0 ***
        ...
        // *** OPTIMIZED MONTE CARLO (v5.1.0) ***
        'runOptimizedMonteCarloBtn', 'optimizedMonteCarloRunsSelect'
    ];
    ...
    // *** MODIFICATION START v5.1.2: Initialize new module ***
    ...
    // *** MODIFICATION START v5.2.0: Add Listeners for JSON Save/Load ***
    elements.save_scenario_btn?.addEventListener('click', () => {
        if (typeof handleSaveScenarioClick === 'function') {
            handleSaveScenarioClick();
        } else {
            console.error('handleSaveScenarioClick function not found. (uiDataHandler.js)');
        }
    });
    elements.load_scenario_btn?.addEventListener('click', () => {
        if (typeof handleLoadScenarioClick === 'function') {
            handleLoadScenarioClick();
        } else {
            console.error('handleLoadScenarioClick function not found. (uiDataHandler.js)');
        }
    });
    elements.scenario_file_input?.addEventListener('change', (event) => {
        if (typeof handleFileSelected === 'function') {
            ...
            console.error('handleFileSelected function not found. (uiDataHandler.js)');
        }
    });
    // *** MODIFICATION END v5.2.0 ***
...
function setLanguage(lang) {
    ...
    document.querySelectorAll('[data-lang-key]').forEach(el => {
        ...
        if (translation !== undefined && translation !== null) {
            if (typeof translation === 'function') { 
                // *** MODIFIED v5.0.0: Add mcSubTitle to function check ***
    ...
    // *** MODIFIED v5.0.0: Check lastRunWasOptimization to update correct results ***
    if (typeof getLastResultDetails === 'function' && getLastResultDetails() && typeof lastRunWasOptimization !== 'undefined' && !lastRunWasOptimization) {
        ...
        if (typeof displayComparisonMetrics === 'function') {
            displayComparisonMetrics(lastResults);
        }
        if (typeof displayComparisonDetailedTable === 'function') {
            displayComparisonDetailedTable(lastResults);
        }
        // Update simComplete message
    ...
    } else if (typeof getLastOptimizationResults === 'function' && getLastOptimizationResults() && typeof lastRunWasOptimization !== 'undefined' && lastRunWasOptimization) {
        // Handle re-language for optimization results
        const lastOptResults = getLastOptimizationResults();
        if (typeof displayOptimizationSummaryTable === 'function') {
            displayOptimizationSummaryTable(lastOptResults);
        }
        if (typeof displayOptimizationDetailedTable === 'function') {
            displayOptimizationDetailedTable(lastOptResults);
        }
        // Redraw graph if needed
        if (typeof drawOptimizationD3Chart === 'function' && elements.graph_container && !elements.graph_container.classList.contains('hidden')) {
             drawOptimizationD3Chart(lastOptResults);
        }
    }
    // *** ADDED v5.0.0: Handle re-language for Monte Carlo results ***
...
function toggleTheme() {
    ...
    // Redraw graph if needed
    // *** MODIFIED v5.0.0: Check lastRunWasOptimization to redraw correct graph ***
    if (typeof lastRunWasOptimization !== 'undefined' && !lastRunWasOptimization) {
        ...
        if (typeof getLastOptimizationResults === 'function' && getLastOptimizationResults() && typeof drawOptimizationD3Chart === 'function' && elements.graph_container && !elements.graph_container.classList.contains('hidden')) {
            drawOptimizationD3Chart(getLastOptimizationResults());
        }
    }
}
function loadTheme() {
...
/**
 * Formats a number for Y-axis labels.
 */
