...
const taxData = {
    FED: {
        ...
        credits: {
            ...
            medicalExpenseThresholdLimit: 2830 // 2025년 추정 한도액 (연방 기준) (v4.1.0 신규 추가)
        }
    },
    ON: {
...
// Source: FSRAO website / Federal PBSA rules (which ON now follows).
// *** MODIFICATION v4.2.0: Replaced old 1/(90-age) formula with current Federal/AB/ON rates ***
...
const lifMaxFactorAge90Plus_ON = 1.00; // *** MODIFICATION v4.2.0: 90세부터 100%
