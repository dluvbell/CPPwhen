 ...
 * @version     3.3.1 (Feature: Add export/graph/table toggles for Optimization results)
 * @file        uiResultsDisplay.js
 * @created     2025-10-25
 * @description Handles running the simulation and displaying results (metrics, table, CSV export, D3 graph, Optimization).
 */
...
async function runAndDisplayAnalysis(showLoader = true) {
    ...
    try {
        ...
        if(elements.toggle_graph_btn) elements.toggle_graph_btn.classList.add('hidden');
        clearD3Chart();
        // Optimizer link clearing removed
